...
// 查询参数类型别名（为了兼容性）
export type AssetQueryParams = AssetQuery;
export type BuildingQueryParams = BuildingQuery;
export type FloorQueryParams = FloorQuery;
export type RoomQueryParams = RoomQuery;
